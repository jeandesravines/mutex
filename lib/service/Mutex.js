...
class Mutex {
	...
	/**
	 * Return a promise on an asynchronous mutex with a parameter to define the minimum interval of time
	...
	/**
	 * Lock the mutex if it is possible and return true if mutex was not already _locked
	 * @returns {boolean}
	 */
	lock() {
